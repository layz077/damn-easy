...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
	     ...
	     http.authorizeRequests()
	         .antMatchers("/login","/register","/","/user/login","/user/delete","/user/autoDelete","/recoverAccount/{id}","/test/image","/user/update").permitAll()
	         .antMatchers("/home","/user/changePassword").hasAnyAuthority("ROLE_USER")
